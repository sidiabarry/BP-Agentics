...
export function ProblemWall() {
  return (
    <section id="problem" className="bg-[var(--hero-exit)] px-5 py-24 md:px-8">
      <div className="mx-auto max-w-6xl">
        <RevealIn as="p" variant="kicker" className="text-sm tracking-[0.2em] text-[#0C5A9A] uppercase">
          Das Ablaufproblem
        </RevealIn>
        ...
        <div className="mt-12 grid items-stretch gap-4 md:grid-cols-2">
          {problems.map((item, index) => (
            <RevealIn
              ...
              variant="card"
              delay={index * 60}
              className="h-full rounded-3xl border border-black/8 bg-white p-7 shadow-[0_20px_50px_-32px_rgba(20,22,28,0.45)]"
            >
