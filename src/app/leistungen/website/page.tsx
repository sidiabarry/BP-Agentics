  ...
  return (
    <DocPage
      ...
      crumbs={[
        ...
        { name: "Website", path: "/leistungen/website" },
      ]}
      extraJsonLd={[
        serviceOffer({
      ...
      related={[
        { href: "/leistungen/ki-setter", label: "KI-Setter nachrüsten, wenn Anfragen liegen bleiben" },
    ...
    >
      ...
      <p>
        ...
        <Link href="/leistungen/ki-setter">KI-Setter</Link> dazu oder danach. Wenn Angebote und Rechnungen bis zum Abend liegen bleiben, gehören die{" "}
      ...
      <p>
        ...
        <Link href="/metallbau">Metallbau</Link>. Die Startseite bleibt die Verkaufsstrecke. Diese Seite ist die Leistungsbeschreibung für Menschen, die „Website Handwerk Hagen Festpreis“ suchen und eine klare Stufe wollen.
      </p>
    </DocPage>
  );
}
