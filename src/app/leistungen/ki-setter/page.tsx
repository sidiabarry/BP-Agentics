  ...
  return (
    <DocPage
      ...
      crumbs={[
        ...
        { name: "KI-Setter", path: "/leistungen/ki-setter" },
      ]}
      extraJsonLd={[
        serviceOffer({
          name: "KI-Setter",
      ...
      related={[
        { href: "/leistungen/website", label: "Website, die die Anfragen überhaupt erst holt" },
        { href: "/leistungen/ablaeufe", label: "Abläufe, wenn nach dem Termin das Papier beginnt" },
        { href: "/referenzen/feinkost-kreta", label: "Kundensystem Feinkost Kreta mit Annahme" },
    ...
    >
      ...
      <p>
        ...
        <Link href="/leistungen/website">Website für Betriebe</Link> holt die Anfrage,{" "}
        <Link href="/leistungen/ablaeufe">interne Abläufe</Link> tragen sie durch den Auftrag. Das Kundensystem von{" "}
        <Link href="/referenzen/feinkost-kreta">Feinkost Kreta</Link> zeigt, wie Annahme und Bestand in einem Weg zusammenlaufen.
      </p>
